      ...
      <div className="w-full max-w-md">
        <Card className="shadow-lg border-t-4 border-t-primary">
          ...
          <CardContent>
            ...
            {loginAttempts > 0 && loginAttempts < MAX_LOGIN_ATTEMPTS && !lockoutTime && <Alert className="mb-4 bg-amber-50 text-amber-800 border-amber-200">
            ...
            <form onSubmit={handleLogin}>
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="email" type="email" placeholder="votre.email@exemple.com" value={email} onChange={e => setEmail(e.target.value)} className="pl-10" disabled={!!lockoutTime} />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="password" type="password" value={password} onChange={e => setPassword(e.target.value)} className="pl-10" disabled={!!lockoutTime} />
                  </div>
                </div>
              ...
              <Button className="w-full mt-6" type="submit" disabled={loading || !!lockoutTime}>
                {loading ? 'Connexion en cours...' : lockoutTime ? `Verrouillé (${formatTimeRemaining(timeRemaining)})` : 'Se connecter'}
              </Button>
            </form>
          </CardContent>
